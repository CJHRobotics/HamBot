class Landmark:
    def __init__(self, x, y, width, height, r, g, b,
        ...
        Args:
            ...
            r (int): Red component of the sampled color (0-255).
            g (int): Green component of the sampled color (0-255).
            b (int): Blue component of the sampled color (0-255).
